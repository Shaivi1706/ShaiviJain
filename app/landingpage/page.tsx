              ...
              <div className="text-center mb-2 md:mb-4 lg:mb-6">
                ...
                >
                  ...
                  {/* <div className="w-full flex justify-center mt-2">
                    <a
                      href="https://codolio.com/profile/Shaivi/problemSolving"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-blue-200 hover:text-white cursor-pointer relative z-50 font-medium text-sm"
                      aria-label="Codolio Profile"
                      onClick={handleSocialClick('https://codolio.com/profile/Shaivi/problemSolving')}
                      style={{
                        transition: 'all 400ms cubic-bezier(0.34, 1.56, 0.64, 1)',
                        opacity: typedText === fullText ? 1 : 0,
                        transform:
